...
class TestExceptionHierarchy:
    def test_authentication_error_is_edge_quake_error(self):
        ...
        assert isinstance(exc, EdgeQuakeError)
...
class TestRaisedFromProvider:
    ...
    def test_unknown_provider_raises_value_error_or_eq_error(self):
        """Completions with bad providers should raise an EdgeQuakeError or ValueError/RuntimeError."""
        from edgequake_python import completion
        with pytest.raises((EdgeQuakeError, ValueError, RuntimeError)):
