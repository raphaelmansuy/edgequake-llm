...
from edgequake_python.config import build_options
...
def completion(
    ...
    **kwargs: Any,
    ...
    """
    if _eq_core is None:
        raise RuntimeError("edgequake_python native extension is not installed. Run `pip install edgequake-python`.")
...
async def acompletion(
    ...
    **kwargs: Any,
    ...
    try:
        return await _eq_core.acompletion(
            provider,
            model_name,
            messages_json,
            options_json,
