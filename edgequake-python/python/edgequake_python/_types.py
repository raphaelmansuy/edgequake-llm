"""
_types.py — Public type definitions for edgequake-python.
...
import from the private ``_eq_core`` extension.
"""
...
# These will exist at runtime; stubs (_eq_core.pyi) provide static types.
try:
    from edgequake_python._eq_core import (  # type: ignore[import]
        ModelResponse,
        Usage,
        ToolCall,
        StreamChunk,
